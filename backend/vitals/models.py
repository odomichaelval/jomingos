...
class VoiceVitalDraft(models.Model):
    #Temporary draft created from voice recording, pending staff review.
    patient = models.ForeignKey(Patient, on_delete=models.CASCADE)
    recorded_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True)
    audio_file = models.FileField(upload_to='voice_vitals/', blank=True, null=True)
    transcript = models.TextField(blank=True)
    
    # AI-extracted draft values (mirrors VitalSigns fields)
    ...
    def __str__(self):
        return f'Voice draft for {self.patient} at {self.created_at}'